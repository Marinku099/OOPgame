...
public class GameRNGOld {
    private static GameRNGOld instance;
    ...
    public static GameRNGOld getInstance() {
        if (instance == null) {
            instance = new GameRNGOld();
        }
        return instance;
    }
    ...
    public Rarity getRandomRarityByWeek() {
        int week = TimeManagement.getInstance().getWeek(); // เรียกใช้ Singleton ของ TimeManagement (ตรวจสอบให้แน่ใจว่าคลาสนั้นมี getInstance())
